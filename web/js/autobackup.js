...
const AUTO_BACKUP_REASON_KEYS = {
  ...
  AddMedGroup: 'settings.backup.autoReason.addMedGroup',
  UpdateMedGroup: 'settings.backup.autoReason.updateMedGroup',
  DeleteMedGroup: 'settings.backup.autoReason.deleteMedGroup',
